...
<head>
	...
	<title> Crear Reporte Diario || EBEH</title>
	<link rel="stylesheet" href="../libs/css/app.css?v=5.0">
	<link rel="stylesheet" href="../libs/css/stylePop.css">
	<script src="../libs/js/main.js?v=5.0"></script>
    ...
    // Seleccionamos el contenedor con id 'prorep-fil'
		...
		<div class="top-menu">
			...
			<section>
				...
				<div class="content content-2">
					<div class="title txt-center"><h2>Reporte Diario Promotor</h2></div>
	...
	<script>
		document.addEventListener('DOMContentLoaded', () => {
			...
			startLoadingBtn.onclick = async () => {
    			...
    			if (file) {
        			try {
        	    		// const userData = await getJSON('imp', 'prorep', 0, 'lib.php');
