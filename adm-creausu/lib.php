...
function cmp_creausu(){
	...
	$c[]=new cmp('perfil','s',3,$d['perfil'],$w.' '.$o,'Perfil','perfil',null,'',true,true,'','col-1',"enabDepeValu('perfil','TEr',['2','6','7']);enabDepeValu('perfil','bIN',['4']);");//enabDepeValu('perfil','bIN',['4']);
