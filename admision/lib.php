 ...
 */
	$id=divide($_POST['id']);
 	$info=datos_mysql("SELECT DISTINCT COUNT(concat(tipo_doc,'_',documento,'_',id_factura)) total
...
function cmp_admision(){
	...
	$c[]=new cmp('fecha_consulta','d',20,$e,$w.' '.$o,'Fecha de la consulta','fecha_consulta',null,'',true,true,'','col-15','validDate(this,-130,0)');
