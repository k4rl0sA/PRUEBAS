...
// var_dump($c);
	...
	if ($a=='adm' && $b=='acciones'){
		...
		$rta.="<li class='icono editar ' title='Editar Facturación' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'admision',event,this,{$cmps},'lib.php');Color('adm-lis');\"></li>";  //act_lista(f,this);
