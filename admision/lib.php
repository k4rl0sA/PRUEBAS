...
function cmp_admision(){
	...
	$c[]=new cmp('fecha_consulta','d',20,$e,$w.' '.$o,'Fecha de la consulta','fecha_consulta',null,'',true,false,'','col-15','validDate(this,-140,0)');
	$c[]=new cmp('tipo_consulta','s',3,$e,$w.' '.$o,'Tipo de Consulta','tipo_consulta',null,'',true,false,'','col-15');
...
// var_dump($c);
	...
	if ($a=='adm' && $b=='acciones'){
		...
		// $cmps ='';
		$rta.="<li class='icono editar ' title='Editar ' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'admision',event,this,'','lib.php');setTimeout(bloqElem,700,['fecha_consulta'],$blo);Color('adm-lis');\"></li>";  //act_lista(f,this);
