...
function cmp_frecuenciauso(){
 ...
 $c[]=new cmp('idp','nu',99999999999999999,$d['id_persona'],$w.' '.$key.' '.$o,'N° Identificación',0,'rgxdfnum','#################',true,$u,'','col-4');
  $c[]=new cmp('tdo','s',3,$d['tipo_doc'],$w.' '.$key.' '.$o,'Tipo Documento','tipo_doc',null,null,true,$u,'','col-3',"getDatForm('find','persona','percit');setTimeout(custSeleDepend,1000,'tdo', 'cit', 'lib.php', {'id_persona': 'idp','tipo_doc':'tdo'});");
