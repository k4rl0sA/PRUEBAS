...
<title>Asignación Relevo || GIF-SDS</title><!--cambiar titulo por orden de fernando-->
...
$mod='asigrelevo';//modulo
$rta=datos_mysql("select FN_USUARIO('".$_SESSION['us_sds']."') as usu;");
$usu=divide($rta["responseResult"][0]['usu']);
// var_dump($usu[1]);
$subred = ($usu[1]=='ADM') ? '1,2,3,4,5' : $usu[2] ;
$colaboradores=opc_sql("SELECT `id_usuario`,nombre FROM `usuarios` WHERE `perfil`IN ('TSOREL','ENFREL','AUXREL','TOPREL','LEFREL','LARREL') AND componente='EAC' AND subred IN(".$subred.") ORDER BY 1",$_SESSION['us_sds']);
...
<div class='col-8 panel' id='<?php echo $mod; ?>'>
      <div class='titulo' >    ASIGNACION RELEVO <!-- CAMBIAR TITULO DE LA VENTANA -->
		<nav class='menu left' >
