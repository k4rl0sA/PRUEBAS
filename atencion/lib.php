...
function lis_homes(){
 ...
 WHERE H.estado_v IN (7) and U.id_usuario ='{$_SESSION['us_sds']}' AND H.usu_creo = '{$_SESSION['us_sds']}' ". whe_homes() .";"; */
// echo $total;
...
WHERE estado_v  in('7') ".whe_homes()." 
    ...
    return create_table($total, $data["responseResult"], "homes", $regxPag);
}
...
function cmp_person(){
	...
	$c[]=new cmp('idpersona','n','15',$d,$w.' '.$o,'Identificación','idpersona',null,null,true,true,'','col-4');
...
// print_r($c);
	...
	if ($a=='famili-lis' && $b=='acciones'){
		$rta="<nav class='menu right'>";		
		$rta.="<li class='icono editar ' title='Editar' id='".$c['ACCIONES']."' Onclick=\"mostrar('homes','pro',event,'','lib.php',7,'homes');setTimeout(getData,300,'homes',event,this,['idviv','numfam']);Color('famili-lis');\"></li>";  //act_lista(f,this);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		$rta.=$perfil;
		if (perfil1()=='MEDATE' || perfil1()=='ADM' || perfil1()=='ENFATE'|| perfil1()=='ADMEAC' ){
