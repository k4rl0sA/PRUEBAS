...
function focus_statFam(){
  ...
  if ($a=='statFam' && isset($acc['crear']) && $acc['crear']=='SI') {  
   ...
   function cmp_statFam(){
    ...
    $c[]=new cmp('estado_fam','s',3,$d['estado_fam'],$w.' '.$o,'Estado de la Visita','estado_fam',null,null,true,$u,'','col-5',"enabStatPreAdm(this,['motivo_estafam']);");//enbValue('estado_fam','StA',5);
