...
function cmp_tamBarthel(){
	...
	$c[]=new cmp('barthel_tipodoc','s','3',$d['barthel_tipodoc'],$w.' '.$o.' '.$key,'Tipo Identificación','barthel_tipodoc',null,'',false,false,'','col-2');
...
function men_tamBarthel(){
   ...
   function cap_menus($a,$b='cap',$con='con') {
	$rta = "";
	$acc=rol($a);
	if ($a=='barthel' && isset($acc['crear']) && $acc['crear']=='SI') {  
