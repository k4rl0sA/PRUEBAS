...
function lis_predios(){
	...
	if($sector!==''){
		$sql="select idgeo 'Codigo',FN_CATALOGODESC(42,hg.estrategia) Estrategia,FN_CATALOGODESC(72,hg.subred) Subred,territorio,direccion,asignado,equipo,estado_v 'estado',usu_creo Creo 
		from hog_geo hg
