...
function cmp_caract(){
	...
	$c[]=new cmp('motivoupd','s','3',$d,$w.' '.$o,'Motivo Actualización','motivoupd',null,'',true,false,'','col-3');
	$c[]=new cmp('eventoupd','s','3',$d,$w.' '.$o,'Evento Actualización','evenupd',null,'',false,true,'','col-3');
	$c[]=new cmp('fechanot','d','10',$d,$w.' '.$o,'fecha Notificación','fechanot',null,'',false,false,'','col-15',"validDate(this,$days,0);");
