   ...
   var_dump($b); 
       if ($a=='caract' && $b=='acciones'){
		...
		if ($a=='homes' && $b=='acciones'){
			$rta="<nav class='menu right'>";
			$rta.="<li class='icono editar ' title='Editar Caracterización' id='".$c['Cod_Familia']."_".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'caract',event,this,'','lib.php');Color('caracteriza-lis');\"></li>";
