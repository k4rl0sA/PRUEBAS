...
function cmp_atencion(){
	...
	$c[]=new cmp('letra1','s','3',$x,$w.' '.$o,'Letra CIE(1)','letra1',null,null,true,true,'','col-1',"selectDepend('letra1','rango1','atencion.php');valPyd(this,'tipo_consulta');valResol('tipo_consulta','letra1');");
