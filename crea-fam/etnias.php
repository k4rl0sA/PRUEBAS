...
function cmp_etnias(){
	...
	$c[]=new cmp('segpeso','sd',6, $d,$w.' '.$z.' '.$o,'Peso (Kg) Mín=0.50 - Máx=150.00','fpe','rgxpeso','###.##',true,true,'','col-10',"valPeso('peso');Zsco('zscore','etnias.php');calImc('peso','talla','imc');");
	...
	$c[]=new cmp('segzscore','t',15,'',$w.' '.$o,'Z-score Peso/Talla','des',null,null,false,false,'','col-25');
