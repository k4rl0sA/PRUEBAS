...
function cmp_etnias(){
	...
	$c[]=new cmp('ftlc','t','100',$d,$w.' '.$o,'Tiene FTLC u otro APME (Cual)','ftlc',null,null,true,true,'','col-5');
	$c[]=new cmp('fecha_Nutri','d','10',$d,$w.' '.$o,'Cita con Nutrición o Pediatria a los 7 Días','fecha_Nutri',null,null,true,true,'','col-20',"validDate(this,$days,0);");
