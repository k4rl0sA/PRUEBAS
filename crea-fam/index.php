...
<script src="../libs/js/a.js?v=29.0"></script>
<script src="../libs/js/x.js?v10.0"></script>
...
function grabar(tb='',ev){
  ...
  'servagen':'../agendamiento/serage.php'
 	};
...
WHERE`perfil` IN('ADM','AUXHOG','PROFAM','MEDICINA','ENFERMERIA','PSICOLOGIA','NUTRICION','TERAPEUTA','AMBIENTAL','ODONTOLOGIA','AGCAMBIO','AUXRELEVO','PSICLINICOS','PROAPO','EMBERA') and subred=(SELECT subred FROM usuarios where id_usuario='{$_SESSION['us_sds']}')  ORDER BY 2",$_SESSION['us_sds']);
...
<div class="col-2 menu-filtro" id='<?php echo$mod; ?>-fil'>
  ...
  <?php
    $filtro = in_array($perfil, ['ADM', 'SUPHOG', 'SUPEAC', 'PROAPO']);
