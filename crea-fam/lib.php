...
// var_dump($a);
	if ($a=='homes' && $b=='acciones'){
 	...
 	if ($a=='famili-lis' && $b=='acciones'){
		...
		$rta.="<li title='Mostrar Integrantes' Onclick=\"mostrar('person1','fix',event,'','lib.php',0,'person1');Color('famili-lis');crearMenu();\"><i class='fa-solid fa-people-group ico' id='".$c['Cod_Familiar']."'></i></li>";
