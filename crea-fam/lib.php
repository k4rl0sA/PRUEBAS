...
// var_dump($a);
	...
	if ($a=='famili-lis' && $b=='acciones'){
		...
		$rta.="<li class='icono familia' title='Crear Caracterización Familiar' id='".$c['ACCIONES']."' Onclick=\"mostrar('person1','fix',event,'','../crea-caract/lib.php',0,'person1');Color('famili-lis');\"></li>";//setTimeout(plegar,500);mostrar('person','pro',event,'','lib.php',7);
