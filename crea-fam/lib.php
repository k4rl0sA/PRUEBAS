...
// var_dump($a);
	...
	if ($a=='famili-lis' && $b=='acciones'){
		...
		$rta.="<li title='Planes de Cuidado Familiar' Onclick=\"mostrar('planDCui','pro',event,'','plancui.php',7);Color('famili-lis');\"><i class='fa-regular fa-id-card ico'  id='".$c['ACCIONES']."'></i></li>";
