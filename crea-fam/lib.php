...
// var_dump($a);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		$rta.="<li class='icono' title='Signos' id='".$c['ACCIONES']."' Onclick=\"mostrar('signos','pro',event,'','signos.php',7,'signos');Color('datos-lis');\"><i class='icono fa-solid fa-ruler-vertical'></i></li>";
