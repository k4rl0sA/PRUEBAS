...
//  var_dump($c);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		if (is_array($tamiz) && in_array('tamcope', $tamiz)) {
			...
			$rta .= acceso('tamzarit') ? "<li title='Tamizaje ZARIT ' onclick=\"mostrar('tamzarit','pro',event,'','../zarit/lib.php',7);Color('datos-lis');\"><i class=' fa-solid fa-think-peaks ico' id='".$c['ACCIONES']."'></i></li>": '';
