...
// var_dump($a);
	...
	if ($a=='famili-lis' && $b=='acciones'){
		...
		$rta.="<li class='icono familia' title='Crear Caracterización Familiar' id='".$c['ACCIONES']."' Onclick=\"mostrar('caract','pro',event,'','../crea-caract/lib.php',0,'caract');Color('famili-lis');\"></li>";//setTimeout(plegar,500);mostrar('person','pro',event,'','lib.php',7);
