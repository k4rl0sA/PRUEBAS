...
//  var_dump($c);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		$rta .= acceso('psicologia') ? "<li title='Psicologia Sesión 1' onclick=\"mostrar('psicologia','pro',event,'','../psicologia/lib.php',7,'psicologia');Color('datos-lis');\"><i class=' fa-solid fa-person-circle-question ico' id='{$c['ACCIONES']}'></i></li>":"";
			...
			if (ember($c['ACCIONES'])) {
				$rta .= acceso('ember') ? "<li title='Grupo Embera' onclick=\"mostrar('groupEtnico','pro',event,'','../etnias/embid.php',7,'gember');Color('datos-lis');\"><i class=' fa-solid fa-person-circle-question ico' id='{$c['ACCIONES']}'></i></li>":"";
			}if (uaic($c['ACCIONES'])) {
