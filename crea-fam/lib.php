...
//  var_dump($c);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		$rta .= acceso('psicologia') ? "<li title='Psicologia Sesión 1' onclick=\"mostrar('psicologia','pro',event,'','../psicologia/lib.php',7,'psicologia');Color('datos-lis');\"><i class=' fa-solid fa-person-circle-question ico' id='{$c['ACCIONES']}'></i></li>":"";
			...
			if (ember($c['ACCIONES'])) {
				$rta .= acceso('ember') ? "<li title='Identificación Embera' onclick=\"mostrar('emb_Id','pro',event,'','../etnias/embid.php',7,'gember');Color('datos-lis');\"><i class=' fa-solid fa-person-circle-question ico' id='{$c['ACCIONES']}'></i></li>":"";
				$rta .= acceso('ember') ? "<li title='Embera Seguimiemnto No Regular' onclick=\"mostrar('segnoreg','pro',event,'','../etnias/embsegnoreg.php',7,'gember');Color('datos-lis');\"><i class=' fa-solid fa-person-circle-question ico' id='{$c['ACCIONES']}'></i></li>":"";
				$rta .= acceso('ember') ? "<li title='Embera Seguimientos' onclick=\"mostrar('seguim','pro',event,'','../etnias/embsegui.php',7,'gember');Color('datos-lis');\"><i class=' fa-solid fa-person-circle-question ico' id='{$c['ACCIONES']}'></i></li>":"";
			}if (uaic($c['ACCIONES'])) {
				$rta .= acceso('uaic') ? "<li title='Identificación UAIC' onclick=\"mostrar('uaic_id','pro',event,'','../etnias/uaicid.php',7,'gember');Color('datos-lis');\"><i class=' fa-solid fa-person-circle-question ico' id='{$c['ACCIONES']}'></i></li>":"";
