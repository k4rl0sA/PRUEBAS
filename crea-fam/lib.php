...
// var_dump($a);
	...
	if ($a=='famili-lis' && $b=='acciones'){
		$rta="<nav class='menu right'>";		
		$rta.="<li title='Editar Familia' Onclick=\"mostrar('homes','pro',event,'','lib.php',7,'homes');Color('famili-lis');\"><i class='fa-solid fa-pen-to-square ico' id='".$c['ACCIONES']."_".$c['Cod_Familiar']."'></li>";  //act_lista(f,this);
		$rta.="<li title='Crear Caracterización Familiar' Onclick=\"mostrar('caract','pro',event,'','../crea-caract/lib.php',7,'caract');Color('famili-lis');\"><i class='fa-solid fa-file-circle-plus ico' id='".$c['ACCIONES']."'></li>";//setTimeout(plegar,500);mostrar('person','pro',event,'','lib.php',7);
