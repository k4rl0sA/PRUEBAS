...
// var_dump($a);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		if (is_array($tamiz) && in_array('tamcope', $tamiz)) {
			$rta .= acceso('tamcope') ? "<li title='Tamizaje COPE' onclick=\"mostrar('tamcope','pro',event,'','../cope/lib.php',7);Color('datos-lis');\"><i class=' fa-solid fa-face-frown ico' id='".$c['ACCIONES']."'></i></li>": '';
		}
		/**********************TAMIZAJES*************************/
