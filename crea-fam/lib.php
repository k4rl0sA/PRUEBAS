...
// var_dump($a);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		$rta.="<li class='icono menubtn' title='Menu' id='men_".$c['ACCIONES']."' Onclick=\"mostrar('aux','men',event,'','lib.php');Color('datos-lis');\"></li><div id='tog_".$c['ACCIONES']."'></div><div id='menu_".$c['ACCIONES']."'></div>";
