...
// var_dump($a);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		$rta.=(acceso('tamApgar')) ? "<li title='Tamizaje Apgar' Onclick=\"mostrar('tamApgar','pro',event,'','../apgar/lib.php',7);Color('famili-lis');\"><i class='fa-solid fa-tree-city ico' id='".$c['ACCIONES']."' ></i></li>":'';
