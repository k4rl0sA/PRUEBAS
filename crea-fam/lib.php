...
// var_dump($a);
	...
	if ($a=='datos-lis' && $b=='acciones'){
		...
		$rta.="<li class='icono menubtn' id='menu_".$c['ACCIONES']."' title='Menu' id='".$c['ACCIONES']."' Onclick=\"mostrar('aux','men',event,'','lib.php');Color('datos-lis');\"></li><div id='tog_".$c['ACCIONES']."'></div><div id='men_".$c['ACCIONES']."'></div>";
