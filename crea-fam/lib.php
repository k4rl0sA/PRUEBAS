...
// var_dump($a);
	...
	if ($a=='famili-lis' && $b=='acciones'){
		...
		$rta.="<li title='Planes de Cuidado Familiar' Onclick=\"mostrar('planDcui','pro',event,'','plancui.php',7);Color('famili-lis');\"><i class='<i class='fa-solid fa-file-contract ico'  id='".$c['Cod_Familiar']."'></i></li>";
