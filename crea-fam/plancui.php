...
return $rta;
  ...
  function get_compConc(){
	...
	function formato_dato($a,$b,$c,$d){
        ...
        $rta.="<li title='Ver Compromiso'><i class='fa-solid fa-eye ico' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getDataFetch,500,'compConc',event,this,'plncon.php',['fecha_caracteriza']);\"></i></li>";
