...
// var_dump($_POST);
 ...
 $c[]=new cmp('estado','s',3,$d['estado'],$w.' PuE '.$o,'estado','estado',null,null,true,$u,'','col-2',"enabStatPreAdm(this,['motivo_estafam'],false);");
 //N° FAMILIA */
/*  $c[]=new cmp('famili','s',3,$d['famili'],$w.' PuE StG '.$o,'famili','famili',null,'',true, $u,'','col-15',"changeSelect('famili','usuario','derireso.php');"); */
 $c[]=new cmp('usuario','s',3,$d['usuario'],$w.' PuE StA '.$o,'usuario','usuario',null,'',true,$u,'','col-25',"changeSelect('usuario','cod_admin','derireso.php');"); //TIPO_DOC,DOCUMENTO Y NOMBRE USUARIO
