...
$scripts = [
    ...
    "ALERTAS" => "SELECT G.idgeo Cod_Predio,F.id_fam AS Cod_Familia,A.id_alert AS Cod_Registro,G.subred AS Subred, G.zona AS Zona, G.localidad AS Localidad, P.idpeople AS Cod_Persona,
...
WHERE AND G.subred in (3) AND date(A.fecha_toma) BETWEEN '2025-02-01' AND CURDATE();",
