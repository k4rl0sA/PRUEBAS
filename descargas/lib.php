...
$scripts = [
    ...
    LEFT JOIN person P ON E.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON E.usu_creo = U.id_usuario  UNION 
    ...
    LEFT JOIN person P ON I.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON I.usu_creo = U.id_usuario  UNION 
    ...
    LEFT JOIN person P ON J.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON J.usu_creo = U.id_usuario  UNION 
    ...
    LEFT JOIN person P ON L.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON L.usu_creo = U.id_usuario  UNION 
    ...
    LEFT JOIN person P ON M.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON M.usu_creo = U.id_usuario  UNION 
    ...
    LEFT JOIN person P ON N.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON N.usu_creo = U.id_usuario  UNION 
    ...
    LEFT JOIN person P ON Q.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON Q.usu_creo = U.id_usuario  UNION 
    ...
    LEFT JOIN person P ON T.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON T.usu_creo = U.id_usuario  UNION 
    ...
    LEFT JOIN person P ON V.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON V.usu_creo = U.id_usuario  UNION 
    ...
    LEFT JOIN person P ON W.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam  LEFT JOIN hog_geo G ON F.idpre = G.idgeo LEFT JOIN usuarios U ON W.usu_creo = U.id_usuario UNION
    SELECT G.subred,G.localidad, F.idpre, F.id_fam,X.Id_mme Cod_Registro,X.idpeople,P.idpersona,P.tipo_doc,CONCAT_WS(' ',P.nombre1,P.nombre2,P.apellido1,P.apellido2) Nombres,P.fecha_nacimiento,P.sexo,P.nacionalidad,P.regimen,P.eapb, X.fecha_seg, X.numsegui,FN_CATALOGODESC(87,X.evento),FN_CATALOGODESC(73,X.estado_s),FN_CATALOGODESC(170,X.cierre_caso),X.fecha_cierre,FN_CATALOGODESC(198,X.motivo_cierre),FN_CATALOGODESC(170,X.activa_ruta) activa_ruta,FN_CATALOGODESC(79,X.ruta) Ruta,X.observaciones,X.users_bina, X.usu_creo, U.nombre, U.perfil FROM `vsp_mme` X  LEFT JOIN person P ON X.idpeople = P.idpeople  LEFT JOIN hog_fam F ON P.vivipersona = F.id_fam 
    LEFT JOIN hog_geo G ON F.idpre = G.idgeo  LEFT JOIN usuarios U ON X.usu_creo = U.id_usuario
