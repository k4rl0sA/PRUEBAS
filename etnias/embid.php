...
function cmp_emb_Id(){
  ...
  $days=fechas_app('ETNIAS');
    ...
    $c[]=new cmp('saberes','s',3,$d['saberes'],$w.' '.$o,'Saberes Propios','saberes',null,null,true,true,'','col-25');
    $c[]=new cmp('enfoque','s',3,$d['enfoque'],$w.' '.$o,'Enfoque Diferencial','enfoque',null,null,true,true,'','col-25');
    $c[]=new cmp('pueblo','s',3,$d['pueblo'],$w.' '.$o,'Pueblo','pueblo',null,null,true,true,'','col-2');
