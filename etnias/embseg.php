...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('asist_controles','s',3,$d['asist_controles'],$w.' '.$o,'Asist de Controles','asist_controles',null,null,false,true,'','col-2');
  $c[]=new cmp('exa_labo','s',3,$d['exa_labo'],$w.' '.$o,'Exa de Labo','exa_labo',null,null,false,true,'','col-2');
  $c[]=new cmp('cons_micronutri','s',3,$d['cons_micronutri'],$w.' '.$o,'Cons de Micronutri','cons_micronutri',null,null,false,true,'','col-2');
  $c[]=new cmp('esq_vacu','s',3,$d['esq_vacu'],$w.' '.$o,'Esq de Vacu','esq_vacu',null,null,false,true,'','col-2');
  $c[]=new cmp('signos_alarma1','s',3,$d['signos_alarma1'],$w.' '.$o,'Signos de Alarma1','signos_alarma1',null,null,false,true,'','col-2');
  $c[]=new cmp('diag_sifigest','s',3,$d['diag_sifigest'],$w.' '.$o,'Diag de Sifigest','diag_sifigest',null,null,false,true,'','col-2');
  $c[]=new cmp('adhe_tto','s',3,$d['adhe_tto'],$w.' '.$o,'Adhe de Tto','adhe_tto',null,null,false,true,'','col-2');
  $c[]=new cmp('diag_sificong','s',3,$d['diag_sificong'],$w.' '.$o,'Diag de Sificong','diag_sificong',null,null,false,true,'','col-2');
  $c[]=new cmp('seg_partera','s',3,$d['seg_partera'],$w.' '.$o,'Seg de Partera','seg_partera',null,null,false,true,'','col-2');
  $c[]=new cmp('seg_med_ancestral1','s',3,$d['seg_med_ancestral1'],$w.' '.$o,'Seg de Med_Ancestral1','seg_med_ancestral1',null,null,false,true,'','col-2');
  ...
  $c[]=new cmp('frec_respiratoria','',3,$d['frec_respiratoria'],$w.' '.$o,'Frec de Respiratoria','frec_respiratoria',null,null,false,true,'','col-2');
  $c[]=new cmp('saturacion','',3,$d['saturacion'],$w.' '.$o,'Saturacion','saturacion',null,null,false,true,'','col-2');
  $c[]=new cmp('gluco','',3,$d['gluco'],$w.' '.$o,'Gluco','gluco',null,null,false,true,'','col-2');
  $c[]=new cmp('peri_cefalico','',2,1,$d['peri_cefalico'],$w.' '.$o,'Peri de Cefalico','peri_cefalico',null,null,false,true,'','col-2');
  $c[]=new cmp('peri_braqueal','',2,1,$d['peri_braqueal'],$w.' '.$o,'Peri de Braqueal','peri_braqueal',null,null,false,true,'','col-2');
  $c[]=new cmp('peso','',5,2,$d['peso'],$w.' '.$o,'Peso','peso',null,null,false,true,'','col-2');
  $c[]=new cmp('talla','',4,1,$d['talla'],$w.' '.$o,'Talla','talla',null,null,false,true,'','col-2');
  $c[]=new cmp('imc','',5,2,$d['imc'],$w.' '.$o,'Imc','imc',null,null,false,true,'','col-2');
