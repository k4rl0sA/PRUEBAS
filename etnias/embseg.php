...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('sistolica','sd',3,$d['sistolica'],$w.' '.$o,'Sistolica','sistolica',null,null,false,true,'','col-2');
  $c[]=new cmp('diastolica','sd',3,$d['diastolica'],$w.' '.$o,'Diastolica','diastolica',null,null,false,true,'','col-2');
  $c[]=new cmp('frec_cardiaca','sd',3,$d['frec_cardiaca'],$w.' '.$o,'Frec de Cardiaca','frec_cardiaca',null,null,false,true,'','col-2');
