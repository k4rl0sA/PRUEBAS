...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('esq_vacu','s',3,$d['esq_vacu'],$w.' '.$o,'Esq de Vacu','rta',null,null,false,true,'','col-2');
  $c[]=new cmp('signos_alarma1','s',3,$d['signos_alarma1'],$w.' '.$o,'Signos de Alarma1','rta',null,null,false,true,'','col-2');
  $c[]=new cmp('diag_sifigest','s',3,$d['diag_sifigest'],$w.' '.$o,'Diag de Sifigest','rta',null,null,false,true,'','col-2');
  $c[]=new cmp('adhe_tto','s',3,$d['adhe_tto'],$w.' '.$o,'Adhe de Tto','rta',null,null,false,true,'','col-2');
  $c[]=new cmp('diag_sificong','s',3,$d['diag_sificong'],$w.' '.$o,'Diag de Sificong','rta',null,null,false,true,'','col-2');
  $c[]=new cmp('seg_partera','s',3,$d['seg_partera'],$w.' '.$o,'Seg de Partera','rta',null,null,false,true,'','col-2');
