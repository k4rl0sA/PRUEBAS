...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('fecha_obs','d',10,$d,$w.' '.$bl.' '.$ge.' '.$o,'Fecha de Evento Obstetrico','fecha_obs',null,null,true,true,'','col-2');
  ...
  $c[]=new cmp('peri_cefalico','sd',4,$d,$w.' '.' men5 ','Perimetro Cefalico (Cm)','peri_cefalico',null,null,false,$men5,'','col-25');

  $men = ($p['mes']>= 6 && $p['ano']< 5) ? true : false ;
  $c[]=new cmp('peri_braqueal','sd',4,$d,$w.' '.' men5 ','Perimetro Braquial  (Cm)','peri_braqueal',null,null,false,$men,'','col-25');
