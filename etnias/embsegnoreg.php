...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('asist_controles','s',3,$d,$w.' '.$bl.' '.$no,'¿Asiste A Controles Prenatales?','rta',null,null,true,true,'','col-2');
  $c[]=new cmp('exa_labo','s',3,$d,$w.' '.$bl.' '.$no,'¿Cuenta Con Exámenes De Laboratorio Al Día? Con Relación Al Trimestre Gestacional?','rta',null,null,true,true,'','col-4');
  $c[]=new cmp('cons_micronutri','s',3,$d,$w.' '.$bl.' '.$no,'¿Consume Micronutrientes?','rta',null,null,true,true,'','col-4');
  $c[]=new cmp('esq_vacu','s',3,$d,$w.' '.$bl.' '.$no,'¿Tiene Esquema De Vacunacion Completo Para La Eg?','rta',null,null,true,true,'','col-3');
