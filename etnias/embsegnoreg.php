...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('aten_med','s',3,$d,$w.' '.$bl.' '.$ge.' '.$o,'Recibio Atención por Medico Ancestral','rta',null,null,false,true,'','col-2');
  $c[]=new cmp('aten_par','s',3,$d,$w.' '.$bl.' '.$ge.' '.$o,'Recibio Atención por Partera','rta',null,null,false,true,'','col-2');
