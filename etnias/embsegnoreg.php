...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('resul_gest','s',3,$d,$w.' '.$bl.' '.$ge.' '.$o,'Resultado De La Gestación','resul_gest',null,null,false,true,'','col-2',"enabPrioEtn();");
  ...
  $c[]=new cmp('saturacion','sd',3,$d,$w.' '.$o,'Saturación (40 a 99 %)','saturacion',null,null,false,true,'','col-25');
  $c[]=new cmp('gluco','sd',3,$d,$w.' '.$o,'Glucometria (40 a 500 mg/dl)','gluco',null,null,false,true,'','col-25');
  ...
  $c[]=new cmp('peso','sd',5,$d,$w.' '.$o,'Peso (Kg)','peso',null,null,false,true,'','col-25',"calImc('peso','talla','imc');");
  $c[]=new cmp('talla','sd',4,$d,$w.' '.$o,'Talla (Cm)','talla',null,null,false,true,'','col-25',"calImc('peso','talla','imc');");
  $c[]=new cmp('imc','sd',5,$d,$w.' '.$o,'Imc','imc',null,null,false,false,'','col-3');
