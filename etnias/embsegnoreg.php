...
function opc_clasi_nutri($id=''){
 ...
 function opc_ser_remigesti($id=''){
	...
	function formato_dato($a,$b,$c,$d){
      ...
      $rta.="<li class='icono editar' title='Editar' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'segnoreg',event,this,['fecha_seg','segui','estado_seg','prioridad','aten_med'],'../etnias/embsegnoreg.php');setTimeout(enabPrioEtn,700);enbValue('id','segnoreg','".$c['ACCIONES']."');enaFie(document.getElementById('observaciones'),false);\"></li>";
			}
		return $rta;
	}
