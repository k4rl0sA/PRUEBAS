...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('fecha_obs','d',10,$d,$w.' '.$bl.' Pue '.$no,'Fecha de Evento Obstetrico','fecha_obs',null,null,true,false,'','col-2');
  ...
  $men = ($p['mes']>143) ? false : true ;
  $c[]=new cmp('sistolica','sd',3,$d,$w.' '.$o,'Valor Sistolica (50 mmhg y 200 mmhg)','sistolica','rgxsisto',null,false,$men,'','col-25');
  $c[]=new cmp('diastolica','sd',3,$d,$w.' '.$o,'Valor Diastolica (30 mmhg y 150 mmhg)','diastolica','rgxdiast',null,false,$men,'','col-25');
...
function opc_clasi_nutri($id=''){
 ...
 function opc_ser_remigesti($id=''){
	...
	function formato_dato($a,$b,$c,$d){
      ...
      $rta.="<li class='icono editar' title='Editar' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'segnoreg',event,this,['fecha_seg','segui','estado_seg','prioridad','aten_med','aten_par','sistolica','diastolica','frec_cardiaca','frec_respiratoria','saturacion','gluco','peso','talla','clasi_nut','ser_remigesti','asist_controles','exa_labo','cons_micronutri','esq_vacu'],'../etnias/embsegnoreg.php');\"></li>";//setTimeout(enabPrioEtn,700);enbValue('id','segnoreg','".$c['ACCIONES']."');enaFie(document.getElementById('observaciones'),false);
			}
		return $rta;
	}
