...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('peso','sd',6,$d,$w.' '.$o,'Peso (Kg)','peso',null,null,false,true,'','col-25',"calImc('peso','talla','imc');Zsco('zscore','embsegnoreg.php');");
  $c[]=new cmp('talla','sd',5,$d,$w.' '.$o,'Talla (Cm)','talla',null,null,false,true,'','col-25',"calImc('peso','talla','imc');Zsco('zscore','embsegnoreg.php');");
