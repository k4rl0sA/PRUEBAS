...
function cmp_segnoreg(){
  ...
  $c[]=new cmp('peri_cefalico','sd',4,$d,$w.' '.' men5 ','Perimetro Cefalico (Cm)','peri_cefalico',null,null,true,$men5,'','col-25');

  $men = ($p['mes']>= 6 && $p['ano']< 5) ? true : false ;
  $c[]=new cmp('peri_braqueal','sd',4,$d,$w.' '.' men5 ','Perimetro Braquial  (Cm)','peri_braqueal',null,null,true,$men,'','col-25');
