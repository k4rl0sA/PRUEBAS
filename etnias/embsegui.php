...
function formato_dato($a,$b,$c,$d){
  ...
  if ($a=='seguim' && $b=='acciones'){
    ...
    $rta.="<li class='icono editar' title='Editar' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'seguim',event,this,['fecha_seg','segui','estado_seg','motivo'],'../etnias/embsegui.php');\"></li>";
    }
		return $rta;
}
