...
['type' => 's', 'value' => $_POST['zcore']??null],
['type' => 's', 'value' => $_POST['clasi_nutri']??null],
...
['type' => 's', 'value' => NULL]
   ...
   $sql="UPDATE uaic_ide SET observacion=?, usu_update=?, fecha_update=DATE_SUB(NOW(), INTERVAL 5 HOUR) WHERE iduaic=?";
    $params = [
