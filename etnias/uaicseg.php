...
function get_uaic_seg(){
  ...
  function opc_motivo_seg($id=''){
	...
	function formato_dato($a,$b,$c,$d){
      ...
      $rta.="<li class='icono editar' title='Editar' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'uaic_seg',event,this,['fecha_seg','segui','estado_seg','motivo_seg'],'../etnias/uaicseg.php');enbValue('iduaicseg','modini','".$c['ACCIONES']."');enaFie(document.getElementById('observaciones'),false);\"></li>";	
			}
		return $rta;
	}
