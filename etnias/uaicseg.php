...
function cmp_uaic_seg(){
  ...
  $w='uaic_seg';
	$t=['iduaicseg'=>'','idpeople'=>'','fecha_seg'=>'','segui'=>'','estado_seg'=>'','motivo_seg'=>'','at_medi'=>'','at_part'=>'','peso'=>'','talla'=>'','zscore'=>'','clasi_nutri'=>'','ftlc_apme'=>'','cual'=>'','cita_nutri7'=>'','cita_nutri15'=>'','cita_nutri30'=>'','observaciones'=>''];
	$o='modini';
  $ob='Ob';
  $no='nO';
  $bl='bL';
  ...
  $c[]=new cmp('sexo','h',1,$p['sexo'],'zsc','sexo','sexo',null,'',false,false,'','col-1');
    ...
    $c[]=new cmp('motivo_seg','s',3,$d['motivo_seg'],$w.' '.$o,'Motivo de Seguimiento','motivo_seg',null,null,true,$x,'','col-25');
    ...
    $c[]=new cmp('cual','t',50,$d['cual'],$w.' '.$bl.' Ftl ','Cual','cual',null,null,true,true,'','col-3');
...
function get_uaic_seg(){
  if($_REQUEST['id']==''){
    ...
    // print_r($id);
    $sql="SELECT null,null,iduaicseg, fecha_seg,segui,estado_seg,motivo_seg,peso,talla,zcore,clasi_nutri,ftlc_apme,cual,cita_nutri7,cita_nutri15,cita_nutri30,observaciones
          FROM `uaic_seg` 
