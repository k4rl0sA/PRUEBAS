...
function cmp_uaic_seg(){
  ...
  var_dump($_POST);
    ...
    $c[]=new cmp('cita_nutri30','s',5,$d['cita_nutri30'],$w.' '.$o,'Cita de Nutri30','rta',null,null,false,true,'','col-2');
    $c[]=new cmp('observaciones','sd',7000,$d['observaciones'],$w.' '.$o,'Observaciones','observaciones',null,null,false,true,'','col-2');
