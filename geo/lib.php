...
function cmp_geoloc(){
	...
	$c[]=new cmp('cod_pre','n','6','',$w.' '.$key.' '.$o,'Codigo del Predio','cod_pre',null,'',true,true,'','col-25',"getDatForm('pRE','predio',['geo']);act_lista('predios','b');");
...
FUNCTION lis_predios(){
	// var_dump($_POST['id']);
	$id =isset($_POST['cod_pre']) ? divide($_POST['cod_pre']) : null;
