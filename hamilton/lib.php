...
function cmp_tamhamilton(){
	...
	$c[]=new cmp('hamilton_tipodoc','s','3',$d['hamilton_tipodoc'],$w.' '.$o.' '.$key,'Tipo Identificación','hamilton_tipodoc',null,'',false,false,'','col-25');
...
function men_tamhamilton(){
   ...
   function cap_menus($a,$b='cap',$con='con') {
	$rta = "";
	$acc=rol($a);
	if ($a=='hamilton' && isset($acc['crear']) && $acc['crear']=='SI') {  
