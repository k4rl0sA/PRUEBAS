...
function lis_tamhamilton(){
	if (!empty($_POST['fidentificacion']) || !empty($_POST['ffam'])) {
		...
		$sql="SELECT O.idpeople ACCIONES,id_hamilton 'Cod Registro',V.id_fam 'Cod Familia',P.idpersona Documento,FN_CATALOGODESC(1,P.tipo_doc) 'Tipo de Documento',CONCAT_ws(' ',P.nombre1,P.nombre2,P.apellido1,P.apellido2) Nombres,total Puntaje,`descripcion` Descripcion, U.nombre Creo,U.subred,U.perfil perfil
