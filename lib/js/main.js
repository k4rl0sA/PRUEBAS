...
if (localStorage.getItem('demo-theme')) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const multipleRemoveSelect = document.getElementsByClassName('choices-multiple-remove-button');
    ...
    const singleSelect = document.getElementsByClassName('single-select');
    if (singleSelect) {
