...
function rol($a){ //a=modulo, b=perfil c=componente
	$rta=array();
	$sql="SELECT perfil,componente,crear,editar,consultar,exportar,importar FROM adm_roles WHERE modulo = '".$a."' and perfil = (select perfil from usuarios where id_usuario='".$_SESSION['us_sds']."') AND componente=(select componente from usuarios where id_usuario='".$_SESSION['us_sds']."') AND estado = 'A'";
