...
function formato_dato($a,$b,$c,$d){
	...
	if ($a=='psicologia' && $b=='acciones'){
		...
		if (isset($info_sesion2['responseResult'][0]) && $info['responseResult'][0]['dias']>$dateMax){
			$rta.="<li class='icono familia' title='Sesión 3, 4, 5, 6' id='".$c['ACCIONES']."' Onclick=\"mostrar('sesiones_psi','pro',event,'','sesiones.php',7);setTimeout(hidFieOpt,500,'psi_validacion7','sem_hide',false);\"></li>";//setTimeout(hidPlan,500,'psi_validacion10','duda_com',false);
		}
