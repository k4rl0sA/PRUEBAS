...
function get_sesion_fin(){
	if($_POST['id']=='0'){
		...
		$id=divide($_POST['id']);
		$sql="SELECT TIMESTAMPDIFF(YEAR, fecha_nacimiento, CURDATE()) AS edad,P.tipo_doc tipo_doc,P.idpersona ocumento,psi_validacion1,psi_validacion2,psi_validacion3,psi_validacion4,psi_validacion5,psi_validacion6,psi_validacion7,psi_validacion8,psi_validacion9,psi_validacion10,estado
