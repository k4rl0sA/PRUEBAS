...
function cmp_sesiones_psi() {
	...
	$c[]=new cmp('psi_validacion10','s','3',$j,$w.' '.$o,'7. ¿Tiene un plan para terminar con su vida dentro de las próximas dos semanas?','en_duda',null,null,$ed,true,'','col-10'); //'hidPlan(\'psi_validacion10\',\'duda_com\');
	$c[]=new cmp('psi_validacion11','a','1500',$j,$w.' duda_com '.$o,'7,1. Describa su plan','psi_validacion11',null,null,$ed,true,'','col-10');
