...
function cmp_sesiones_psi() {
	...
	$c[]=new cmp('psi_fecha_sesion','d','10',$j,$w.' '.$o,'Fecha de la Sesion','psi_fecha_sesion',null,null,true,true,'','col-3','validDate(this,-60,0);');
...
function formato_dato($a,$b,$c,$d){
	...
	if ($a=='sesiones' && $b=='acciones'){
		$rta="<nav class='menu right'>";	
			...
			$rta.="<li class='icono editar ' title='Editar Sesiones' id='".$c['ACCIONES']."' Onclick=\"Color('sesiones');setTimeout(getData,300,'sesiones_psi',event,this,['psi_fecha_sesion','psi_sesion','cod_admin4','psi_validacion17'],'sesiones.php');\"></li>";  //getData('plancon',event,this,'id');act_lista(f,this);
		}
return $rta;
}