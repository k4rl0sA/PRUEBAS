...
function cmp_relevo() {
	...
	$c[]=new cmp('fecha_acep','d','10',$j['fecha_acep'],$w.' fre '.$o,'Fecha de la Aceptacion','fecha_acep',null,null,false,false,'','col-25','validDate(this,-22)');
	...
	$c[]=new cmp('whodas1','t','3',$j['whodas1'],$w.' '.$o,'WHODAS INTERPRETACIÓN - Inicial','whodas1',null,null,true,true,'','col-15');
	$c[]=new cmp('cert_disca1','s','3',$j['cert_disca1'],$w.' '.$o,'Cuenta con Certificado de Discapacidad','aler',null,null,true,true,'','col-15',"enabMod(this,'mod');");
	...
	$c[]=new cmp('whodas2','t','3',$j['whodas2'],$w.' cr2 '.$o,'WHODAS INTERPRETACIÓN - Inicial','whodas2',null,null,false,false,'','col-15');
	$c[]=new cmp('cert_disca2','s','3',$j['cert_disca2'],$w.' '.$o,'Cuenta con Certificado de Discapacidad','aler',null,null,true,true,'','col-15',"enabMod(this,'mod');");
	...
	$c[]=new cmp('whodas3','t','3',$j['whodas3'],$w.' cr3 '.$o,'WHODAS INTERPRETACIÓN - Inicial','whodas3',null,null,false,false,'','col-15');
	$c[]=new cmp('cert_disca3','s','3',$j['cert_disca3'],$w.' '.$o,'Cuenta con Certificado de Discapacidad','aler',null,null,true,true,'','col-15',"enabMod(this,'mod');");
...
function opc_rel_validacion13($id='') {
	...
	$id=divide($_REQUEST['id']);
		return	opc_sql("SELECT idpersona,concat_ws(' ',nombre1,nombre2,apellido1,apellido2) 'Nombres' 
			from person 
			swhere vivipersona=(select vivipersona from person where idpeople='$id[0]') and idpeople<>'$id[0]'",$id);
			// var_dump($id);
