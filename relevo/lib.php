...
function cmp_relevo() {
	...
	$c[]=new cmp('cert_disca2','s','3',$j['cert_disca2'],$w.' cr2 '.$o,'Cuenta con Certificado de Discapacidad','aler',null,null,true,true,'','col-15');
	...
	$c[]=new cmp('cert_disca3','s','3',$j['cert_disca3'],$w.' cr3 '.$o,'Cuenta con Certificado de Discapacidad','aler',null,null,true,true,'','col-15');
