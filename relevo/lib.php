...
function cmp_relevo() {
	...
	$c[]=new cmp('cuidado_1','s','18',$j['cuidado_1'],$w.' care '.$o,'Seleccione Usuario que requiere cuidado','rel_validacion13',null,null,true,false,'','col-25',"validCare('care');");
	$c[]=new cmp('antecedentes_1','s','3',$j['antecedentes_1'],$w.' '.$o,'ANTECEDENTES PATOLOGICOS','antecedentes',null,null,true,false,'','col-25',"othePath(this,'ot');");
