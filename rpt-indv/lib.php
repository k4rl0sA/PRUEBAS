    ...
    <div class="tab-panel">
      ...
      <div class="tab-content activ" data-content="1">
		...
		<div class="title-risk">Caracterización</div>
			...
			<div class="user-info section">
				<div class="user-details">
					<div><b class="tooltips">Self Reporting Questionnaire. Identifica pacientes con alta probabilidad de estar sufriendo una enfermedad mental.(Población mayor a 16 años)"><b>SRQ :</b> 20</div>
					<div><b class="tooltips"> Finnish Diabetes Risk Score. Evalua el riesgo de una persona de desarrollar diabetes mellitus tipo 2 en los próximos 10 años.(Población mayor a 17 años)"><b>Findrisc :</b>'.$d["Puntaje_Findrisc"].' '.$d["Riesgo_Findrisc"].'</div>
			 	</div>
				<div class="user-details">
					<div><b class="tooltips">RQC : 30<span class="tooltiptext">Reporting Questionnaire for Children. Identifica problemas de salud mental en población infantil no psiquiátrica.(Población entre 5 y 15 años)</span></b></div>
					<div><b class="tooltips">COPE : <span class="tooltiptext">Cuestionario Multidimensional de Afrontamiento (Evalua las diferentes formas de respuesta ante el estrés.)</span></b>'.$d["Puntaje_Cope"].' '.$d["Riesgo_Cope"].'</div>
				</div>
				<div class="user-details">
					<div><b class="tooltips"> Enfermedad Pulmonar Obstructiva Crónica (Población de 40 años o más)"><b>EPOC :</b> '.$d["Puntaje_Epoc"].' '.$d["Riesgo_Epoc"].'</div>
				</div>
			</div>
		<div class="user-info section">
			<div class="user-details">
				<div><b class="tooltips"> El Zarit Burden Inventory, conocido en nuestro medio como cuestionario de Zarit (aunque tiene diversas denominaciones tanto en inglés como en español), es un instrumento que cuantifica el grado de sobrecarga que padecen los cuidadores de las personas dependientes."><b>Zarith :</b> '.$d["Puntaje_Zarit"].' '.$d["Riesgo_Zarit"].'</div>
				<div><b class="tooltips"> Self Reporting Questionnaire. Para identificar pacientes con alta probabilidad de estar sufriendo una enfermedad mental"><b>Hamilton :</b> '.$d["Puntaje_Hamilton"].' '.$d["Riesgo_Hamilton"].'</div>
			</div>
			<div class="user-details">
				<div><b class="tooltips"> Self Reporting Questionnaire. Para identificar pacientes con alta probabilidad de estar sufriendo una enfermedad mental"><b>Zung :</b> '.$d["Puntaje_Zung"].' '.$d["Riesgo_Zung"].'</div>
				<div><b class="tooltips"> Self Reporting Questionnaire. Para identificar pacientes con alta probabilidad de estar sufriendo una enfermedad mental"><b>Ophi II :</b> '.$d["Puntaje_Ophi"].'</div>
			</div>
		</div>
	</div>
	</div>
