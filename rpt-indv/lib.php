    ...
    <div class="tab-panel">
      ...
      <div class="tab-content activ" data-content="1">
		...
		<div class="title-risk">Caracterización</div>
			...
			<div class="user-info section">
				<div class="user-details">
					<div class="tooltip">Self Reporting Questionnaire. Identifica pacientes con alta probabilidad de estar sufriendo una enfermedad mental.(Población mayor a 16 años)"><b>SRQ :</b> 20</div>
					<div class="tooltip">Finnish Diabetes Risk Score. Evalua el riesgo de una persona de desarrollar diabetes mellitus tipo 2 en los próximos 10 años.(Población mayor a 17 años)"><b>Findrisc :</b>'.$d["Puntaje_Findrisc"].' '.$d["Riesgo_Findrisc"].'</div>
			 	</div>
				<div class="user-details">
				...
				<div class="user-details">
					<div class="tooltip">Enfermedad Pulmonar Obstructiva Crónica (Población de 40 años o más)"><b>EPOC :</b> '.$d["Puntaje_Epoc"].' '.$d["Riesgo_Epoc"].'</div>
				</div>
			</div>
		<div class="user-info section">
			<div class="user-details">
				...
				<div class="tooltip">Self Reporting Questionnaire. Para identificar pacientes con alta probabilidad de estar sufriendo una enfermedad mental"><b>Hamilton :</b> '.$d["Puntaje_Hamilton"].' '.$d["Riesgo_Hamilton"].'</div>
			</div>
			<div class="user-details">
				<div class="tooltip">Self Reporting Questionnaire. Para identificar pacientes con alta probabilidad de estar sufriendo una enfermedad mental"><b>Zung :</b> '.$d["Puntaje_Zung"].' '.$d["Riesgo_Zung"].'</div>
				<div class="tooltip">Self Reporting Questionnaire. Para identificar pacientes con alta probabilidad de estar sufriendo una enfermedad mental"><b>Ophi II :</b> '.$d["Puntaje_Ophi"].'</div>
			</div>
		</div>
	</div>
	</div>
