		...
		<div class="title-risk">Caracterización</div>
			...
			<div class="user-info section">
				...
				<div class="user-details">
					...
					<div><b>COPE 28 :</b>'.$d["Puntaje_Cope"].' '.$d["Riesgo_Cope"].'span class="tooltiptext">Cuestionario Multidimensional de Afrontamiento (Evalua las diferentes formas de respuesta ante el estrés.)</span></div>
				</div>
				<div class="user-details">
