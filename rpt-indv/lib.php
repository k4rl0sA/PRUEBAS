...
function cmp_rptindv(){
    ...
    <div class="tab-panel">
      <ul class="tab-nav">
        <li class="tab activ" data-tab="1"><i class="fa-solid fa-book-medical"></i>Tab 1</li>
        <li class="tab " data-tab="2"><i class="fa-solid fa-hand-holding-medical"></i>Tab 2</li>
        <li class="tab " data-tab="3"><i class="fa-solid fa-viruses"></i>Tab 3</li>
      </ul>
