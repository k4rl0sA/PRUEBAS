...
//  var_dump($d['estado_g']);
 ...
 $c[]=new cmp('gestion','s',2,$d['gestion'],$w.' '.$o,'estado','gestion',null,null,true,$x,'','col-2',"enabEtap('gestion',['pRe','PuE']);");
 $c[]=new cmp('fecha_gestion','d','10',$d['fecha_gestion'],$w.' PuE '.$o,'Fecha de Gestion','fecha_gestion',null,null,true,$x,'','col-2','validDate(this,-2,0);');
 $c[]=new cmp('estado_g','s',2,$d['estado_g'],$w.' PuE '.$o,'estado','estado_g',null,null,true,$x,'','col-2',"enabFielSele(this,['motivo_estado']);tipVivi('estado_g','StG');");
 ...
 $c[]=new cmp('estado','s',3,'',$w.' pRe  StG '.$o,'estado','estado',null,null,true,false,'','col-2',"changeSelect('estado','famili');");
 $c[]=new cmp('famili','s',3,'',$w.' pRe StG '.$o,'famili','famili',null,'',false, false,'','col-3',"changeSelect('famili','usuario');");//N° FAMILIA
 $c[]=new cmp('usuario','s',3,'',$w.' pRe StG '.$o,'usuario','usuario',null,'',false, false,'','col-3',"changeSelect('usuario','cod_admin');"); //TIPO_DOC,DOCUMENTO Y NOMBRE USUARIO
 $c[]=new cmp('cod_admin','s',3,$d['cod_admin'],$w.' pRe StG '.$o,'cod_admin','cod_admin',null,'',false, false,'','col-2');//traer los codigos del usuario de atencion
