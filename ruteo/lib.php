...
function get_rute(){
	if($_POST['id']=='0'){
		...
		sector_catastral,nummanzana,predio_num,unidad_habit,`cordx`, `cordy`, `perfil_asignado`,`fecha_gestion`, `estado_g`, `motivo_estado`, `direccion_nueva`, `complemento`, `observacion`,integrantes,predio,cod_admin,localidad,direccion
		 FROM `eac_ruteo` R
