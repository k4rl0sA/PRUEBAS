...
//  var_dump($d['estado_g']);
 ...
 $c[]=new cmp('gestion','s',2,$d['gestion'],$w.' '.$o,'estado','gestion',null,null,true,$x,'','col-2',"tipVivi('estado_g','pRe');enabOthNo('estado_g','PuE');");
 ...
 $c[]=new cmp('estado','s',3,'',$w.' PuE StG '.$o,'estado','estado',null,null,true,false,'','col-2',"changeSelect('estado','famili');");
