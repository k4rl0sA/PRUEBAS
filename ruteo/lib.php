...
function get_rute(){
	if($_POST['id']=='0'){
		...
		G.sector_catastral,G.nummanzana,G.predio_num,G.unidad_habit,G.`cordx`, G.`cordy`,RG.fecha_gestion,RG.estado_g,RG.motivo_estado,RG.sector_catastral,RG.nummanzana,RG.predio_num,RG.observaciones
		 FROM `eac_ruteo` R
