...
function lis_rute(){
	...
	$sql="SELECT ROW_NUMBER() OVER (ORDER BY 1) R,`id_ruteo` ACCIONES,nombres,`fecha_asig` Asignado,FN_CATALOGODESC(191,priorizacion) Priorización,estado_g Gestionado,estado
  FROM `eac_ruteo` 
  WHERE 1 ";
