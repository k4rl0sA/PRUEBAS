...
//  var_dump($d);
 ...
 $c[]=new cmp('estado','s',3,$d['predio'],$w.' PuE '.$o,'estado','estado',null,null,true,$u,'','col-2',"changeSelect('estado','famili');enabDepeValu('estado','StG',['RECHAZADO','FALLIDO','NO RESIDENCIAL']);");
