...
function cmp_rutclasif(){
 ...
 $c[]=new cmp('accion','s','10','',$w.' '.$o,'Definir Acción','clasificacion',null,null,true,$u,'','col-2');
 $c[]=new cmp('fecha','d','10','',$w.' '.$o,'Fecha de Programación','fecha',null,null,true,$u,'','col-2','validDate(this,-2,0);');
