...
LEFT JOIN apro_terr A ON G.territorio = A.territorio  ".whe_rute();
	...
	WHERE A.doc_asignado ='".$_SESSION['us_sds']."'";
		...
		$tot="SELECT  COUNT(*) AS total FROM eac_ruteo R LEFT JOIN hog_geo G ON R.idgeo = G.idgeo LEFT JOIN apro_terr A ON G.territorio = A.territorio AND R.actividad1 = A.doc_asignado	WHERE A.doc_asignado ='".$_SESSION['us_sds']."';";
		// echo $sql;
