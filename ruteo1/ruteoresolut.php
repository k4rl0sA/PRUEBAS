...
//  $c[]=new cmp('est','s',3,$d['estado'],$w.' '.$o,'Estado Ruteo','estado_rut',null,null,true,$u,'','col-2');
...
function get_ruteresol(){
	if($_POST['id']=='0'){
		...
		$id=divide($_POST['id']);
		// var_dump($id);
		$sql="SELECT id_ruteo,fecha,estado_rut,famili,usuario FROM `eac_ruteo` WHERE  id_ruteo='{$id[0]}'";
		$info=datos_mysql($sql);
