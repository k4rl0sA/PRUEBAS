...
function cmp_ruteresol(){
 $rta="";
 $t=['id_ruteo'=>'','estado_ruteo'=>'','estado_rut'=>'','famili'=>'','usuario'=>'','fecha'=>''];
 $w='ruteresol';
 $d=get_ruteresol(); 
 if ($d=="") {$d=$t;}
...
//  var_dump($d);
 ...
 $c[]=new cmp('est','s',3,$d['estado_ruteo'],$w.' '.$o,'Estado Ruteo','estado_ruteo',null,null,true,$u,'','col-2',"changeSelect('estado','famili');enabDepeInner('estado','StG',['RECHAZADA','FALLIDO','NO RESIDENCIAL']);");
 $c[]=new cmp('fecha','d',3,$d['fecha'],$w.' PuE '.$o,'Fecha','fecha',null,null,true,false,'','col-2',"validDate(this,$days,7);");
 $c[]=new cmp('estado','s',3,$d['estado_rut'],$w.' PuE '.$o,'Estado Predio','estado',null,null,true,false,'','col-2',"changeSelect('estado','famili');enabDepeInner('estado','StG',['RECHAZADA','FALLIDO','NO RESIDENCIAL']);");
 $c[]=new cmp('famili','s',3,$d['famili'],$w.' PuE StG '.$o,'famili','famili',null,'',true, false,'','col-15',"changeSelect('famili','usuario');");//N° FAMILIA
 $c[]=new cmp('usuario','s',3,$d['usuario'],$w.' PuE StG '.$o,'usuario','usuario',null,'',true,false,'','col-45'); //TIPO_DOC,DOCUMENTO Y NOMBRE USUARIO
