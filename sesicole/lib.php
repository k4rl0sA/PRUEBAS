...
function cmp_sesigcole(){
	...
	/* $c[]=new cmp('tipose','s','3',$d,$w.' '.$o,'Tipo de Actividad','tipose',null,null,true,true,'','col-10');
	$c[]=new cmp('tem1','o',2,$d,$w.' '.$o,'Tematica Abordada 1','sp3',null,null,false,true,'','col-1');
	$c[]=new cmp('abo1','s','3',$d,$w.' '.$o,'¿Cual tematica 1?','tipose',null,null,true,true,'','col-2');
	$c[]=new cmp('tem2','o',2,$d,$w.' '.$o,'Tematica Abordada 2','sp1',null,null,false,true,'','col-1');
 ...
 */	$c[]=new cmp('seg_pre3','o',2,$d,$w.' '.$o,'¿Hubo alguna vez en que usted haya comido poca variedad de alimentos por falta de dinero u otros recursos?','sp3',null,null,false,true,'','col-10');
	$c[]=new cmp('seg_pre3','o',2,$d,$w.' '.$o,'¿Hubo alguna vez en que usted haya comido poca variedad de alimentos por falta de dinero u otros recursos?','sp3',null,null,false,true,'','col-10');$c[]=new cmp('seg_pre3','o',2,$d,$w.' '.$o,'¿Hubo alguna vez en que usted haya comido poca variedad de alimentos por falta de dinero u otros recursos?','sp3',null,null,false,true,'','col-10');$c[]=new cmp('seg_pre3','o',2,$d,$w.' '.$o,'¿Hubo alguna vez en que usted haya comido poca variedad de alimentos por falta de dinero u otros recursos?','sp3',null,null,false,true,'','col-10');$c[]=new cmp('seg_pre3','o',2,$d,$w.' '.$o,'¿Hubo alguna vez en que usted haya comido poca variedad de alimentos por falta de dinero u otros recursos?','sp3',null,null,false,true,'','col-10');
