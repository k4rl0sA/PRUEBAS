...
function cmp_sesigcole(){
	...
	$c[]=new cmp('id','t','20',$_POST['id'],$w.' '.$o,'','',null,null,true,false,'','col-1');
	$c[]=new cmp('fecha_int','d','10',$d['fecha'],$w.' '.$o,'fecha_Intervencion','fecha_int',null,null,true,false,'','col-15',"validDate(this,$days,0);");
