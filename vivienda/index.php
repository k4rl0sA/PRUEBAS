...
$territorio = ($perfil == 'APYHOG' || $perfil == 'ADM' || $perfil == 'ADMHOG' || $perfil == 'SUPHOG') ? '' : 'disabled';
?>
...
<div class='col-8 panel' id='<?php echo $mod; ?>'>
      <div class='titulo' >    CARACTERIZACIÓN VIVIENDAS
		<nav class='menu left'>
			...
			<li class='icono ambi1' title='Consultar Predio' Onclick="mostrar('predios','pro',event,'','../consultar/consulpred.php',7);">
		</nav>
