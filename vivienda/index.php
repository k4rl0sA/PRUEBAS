...
$territorio = ($perfil == 'GEO' || $perfil == 'ADM' || $perfil == 'ADMEAC') ? '<div class="campo"><div>Territorio</div><select class="captura" id="fterri" name="fterri" onchange="actualizar();">' .$territorios. '</select></div>' : '';
?>
