...
function cmp_homes(){
	...
	$c[]=new cmp('fechaupd','d','10',$d,$w.' '.$o,'fecha Actualización','fechaupd',null,'',false,true,'','col-15',"addupd(this,'hid','motivoupd');validDate(this,$days,0);");
	...
	if ($a=='homes' && $b=='acciones'){
		...
		if ($a=='famili-lis' && $b=='acciones'){
			$rta="<nav class='menu right'>";		
				...
				$rta.="<li class='icono editar ' title='Editar' id='".$c['ACCIONES']."' Onclick=\"mostrar('homes','pro',event,'','lib.php',7,'homes');setTimeout(getData,1000,'homes',event,this,['idviv','numfam','estado_aux','equipo_car']);setTimeout(disFecar,1100,'fecha');Color('famili-lis');\"></li>";  //act_lista(f,this);
