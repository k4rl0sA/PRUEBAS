...
function men_medidas(){
   ...
   function cmp_medidas(){
	...
	$c[]=new cmp('selmul10[]','m',3,$d,$w.' der '.$o,'Derivaciones','selmul10',null,'',false,false,'','col-3',"enabSelMulSel('fselmul10[]', 'deriva_eac', ['5A', 'SB']);");
	$c[]=new cmp('deriva_eac','s',15,$d,$w.' '.$o,'Deriva a EAC','rta',null,null,true,true,'','col-1',"enabOthSi('deriva_eac','eAc');enabSelMulSel('fselmul10[]', 'deriva_eac', ['5A', 'SB'])");
