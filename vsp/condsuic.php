...
function cmp_condsuic(){
  ...
  $c[]=new cmp('cons_micronutr','s','2',$d,$w.' '.$bl.' '.$ge.' '.$gp.' '.$o,'¿Consume Micronutrientes?','rta',null,null,false,$x,'','col-2');
    ...
    $c[]=new cmp('cierre_caso','s','2',$d,$w.' '.$o,'Cierre de Caso','rta',null,null,false,$x,'','col-1',"enabOthSi('cierre_caso','cc');");
    //igual

    $c[]=new cmp('fecha_cierre','d','10',$d,$w.' cc '.$bl.' '.$no.' '.$o,'Fecha de Cierre','fecha_cierre',null,null,false,$x,'','col-15','validDate(this,-20,0);');
    ...
    $c[]=new cmp('cope_afronta','s','3',$d,$w.' cO '.$bl.' '.$o,'Total Afrontamiento','cope_afronta',null,null,false,$x,'','col-2');
    $c[]=new cmp('cope_evitacion','s','3',$d,$w.' cO '.$bl.' '.$o,'Total Evitación','cope_evitacion',null,null,false,$x,'','col-2');
    $c[]=new cmp('incremen_afron','s','3',$d,$w.' cO '.$bl.' '.$o,'Se Evidencia Incremento Estrategias de Afrontamiento','incremen_afron',null,null,false,$x,'','col-2');
    $c[]=new cmp('incremen_evita','s','3',$d,$w.' cO '.$bl.' '.$o,'Se Evidencia Decremento Estrategias de Evitacion','incremen_evita',null,null,false,$x,'','col-2');
