...
// $nb='disa oculto';
  ...
  $o='hab';
    ...
    $c[]=new cmp('fec_hb_recnac','d','10',$d,$w.' Rg '.$bl.' '.$pu.' '.$o,'Fecha de vacuna HB del recién nacido','fec_hb_recnac',null,null,false,$x,'','col-15');
    $c[]=new cmp('reci_inmunoglo','s','2',$d,$w.' Rg '.$bl.' '.$pu.' '.$o,'¿Recibe Inmunoglobulina?','rta',null,null,false,$x,'','col-1');
    $c[]=new cmp('seg_eps','s','2',$d,$w.' '.$bl.' Rg '.$pu.' '.$o,'¿Se evidencia seguimiento desde su EPS?','rta',null,null,false,$x,'','col-2');
    
    $o='hab';
    $c[]=new cmp($o,'e',null,'INFORMACIÓN ANTIGENOS',$w);
    $c[]=new cmp('antige_super1','s','2',$d,$w.' '.$o,'Antígeno de Superficie','rta',null,null,false,$x,'','col-25',"enabOthSi('antige_super1','A1');");
    $c[]=new cmp('resultado1','s','2',$d,$w.' A1 '.$bl.' '.$o,'Resultado','rta1',null,null,false,$x,'','col-25');
    $c[]=new cmp('anticor_igm_hb1','s','2',$d,$w.' '.$o,'AntiCore Igm HB','rta',null,null,false,$x,'','col-25',"enabOthSi('anticor_igm_hb1','a2');");
    $c[]=new cmp('resultado2','s','2',$d,$w.' a2 '.$bl.' '.$o,'Resultado','rta1',null,null,false,$x,'','col-25');
    $c[]=new cmp('anticor_toigm_hb1','s','2',$d,$w.' '.$o,'AntiCore Total Igm HB','rta',null,null,false,$x,'','col-25',"enabOthSi('anticor_toigm_hb1','A3');");
    $c[]=new cmp('resultado3','s','2',$d,$w.' A3 '.$bl.' '.$o,'Resultado','rta1',null,null,false,$x,'','col-25');
