		...
		if ($a=='famili-lis' && $b=='acciones'){
			...
			switch (eac($c['Cod_Familia'])) {
				...
				if(plan($c['Cod_Familia'])===true){
					$rta.="<li class='icono comp1' title='Compromisos Concertados' id='".$c['ACCIONES']._'VSP'."' Onclick=\"mostrar('compConc','pro',event,'','../vivienda/plncon.php',7);Color('famili-lis');\"></li>";
				}
