...
function cmp_homes(){
	...
	$c[]=new cmp('fecha','d','10',$d,$w.' '.$o,'fecha Caracterización','fecha',null,'',true,true,'','col-2','validDate(this,-50,0)');
	...
	$c[]=new cmp('fechaupd','d','10',$d,$w.' '.$o,'fecha Actualización','fechaupd',null,'',false,true,'','col-2','addupd(this,\'hid\',\'motivoupd\');validDate(this,-50,0);');
	...
	$c[]=new cmp('telefono2','n','10',$d,$w.' '.$o.' '.$n,'telefono2','telefono2','rgxphone1',null,false,true,'','col-3');
	$c[]=new cmp('telefono3','n','10',$d,$w.' '.$o.' '.$n,'telefono3','telefono3','rgxphone1',null,false,true,'','col-4');
...
function gra_person(){
	...
	$c[]=new cmp('fecha_caracteriza','d','10',$d['fecha'],$w.' '.$o,'fecha_caracteriza','fecha_caracteriza',null,null,false,true,'','col-2','validDate(this,-75,0)');
	...
	$c[]=new cmp('cumplio','o','2',$e,$w.' '.$o,'cumplio','cumplio',null,null,true,true,'','col-1');
	for ($i=0;$i<count($c);$i++) $rta.=$c[$i]->put();
