...
function cmp_mme(){
  ...
  $c[]=new cmp('tiposeg','s','3',$ev,$w.' '.$o,'Tipo de Seguimiento','tiposeg',null,null,false,true,'','col-2',"enabEtap('tiposeg',['aST']);");
  ...
  $o='gest';
    ...
    $c[]=new cmp('tipo_tratafarma','m','3',$d,$w.' pRe FaR '.$o,'Tipo de Tratamiento','tipo_tratafarma',null,null,false,$x,'','col-2',"fieldsValue('ftipo_tratafarma','TfR','5',false);");
    $c[]=new cmp('cualtra','t','100',$d,$w.' pRe TfR '.$o,'Cuál','cual',null,null,false,$x,'','col-4');
    ...
    $c[]=new cmp('asis_ctrl_postpar_espe','s','3',$d,$w.' PuE aST '.$o,'¿Asistió a control post parto?','rta2',null,null,false,$x,'','col-2',"enabOthSi('ctrl_postpar_espe','Esp');validDate(this,-400,0);EnabDepe2fiel('NPp','2','2','ctrl_postpar_espe','asis_ctrl_postpar_espe',true,false);EnabDepe2fiel('NPp','2','2','ctrl_postpar_espe','asis_ctrl_postpar_espe',false,true);");
