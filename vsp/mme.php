...
function cmp_mme(){
  ...
  $o='gest';
    ...
    $c[]=new cmp('tipo_tratafarma','m','3',$d,$w.' pRe '.$o,'Tipo de Tratamiento','tipo_tratafarma',null,null,false,$x,'','col-2',"fieldsValue('ftipo_tratafarma','TfR','5',false);");
    $c[]=new cmp('cual','t','100',$d,$w.' pRe TfR '.$o,'Cuál','cual',null,null,false,$x,'','col-4');
    ...
    $c[]=new cmp('desc_sigala','t','500',$d,$w.' PuE MFe '.$o,'Descripcion del signo de alarma','desc_sigala',null,null,false,$x,'','col-4');
    $c[]=new cmp('disc_ges','s','3',$d,$w.' PuE '.$o,'¿La gestante presenta alguna discapacidad o secuela posterior al evento obstetrico?','rta',null,null,false,$x,'','col-3',"enabOthSi('disc_ges','MAc');");
    ...
    $c[]=new cmp('cam_sign','s','3',$d,$w.' PuE '.$o,'Considera que ha tenido cambios significativos recientes a nivel emocional, psicológico o comportamental (por ejemplo cambios de estado de ánimo o dificultades en el sueño)','rta',null,null,false,$x,'','col-4',"enabOthSi('cam_sign','lME');");
...
function gra_mme(){
  ...
  if(count($id)==4){
    ...
    ['type' => 's', 'value' => $_POST['asis_ctrpre']],
    ['type' => 's', 'value' => $_POST['ing_ctrpre']],
    ['type' => 's', 'value' => $_POST['cpn']],
    ['type' => 's', 'value' => $_POST['porque_no']],
    ['type' => 's', 'value' => $_POST['exam_lab']],
    ['type' => 's', 'value' => $_POST['esqu_vacuna']],
    ['type' => 's', 'value' => $_POST['cons_micronutr']],
    ['type' => 's', 'value' => $_POST['trata_farma']],
    ['type' => 's', 'value' => $_POST['tipo_tratafarma']],
    ['type' => 's', 'value' => $_POST['cual']],
    ['type' => 's', 'value' => $_POST['adhe_tratafarma']],
    ['type' => 's', 'value' => $_POST['porque_noadh']],
    ['type' => 's', 'value' => $_POST['peso']],
    ['type' => 's', 'value' => $_POST['talla']],
    ['type' => 's', 'value' => $_POST['imc']],
    ['type' => 's', 'value' => $_POST['clasi_nutri']],
    ['type' => 's', 'value' => $_POST['signos_alarma_seg']],
    ['type' => 's', 'value' => $_POST['descr_sigalarma']],
    ['type' => 's', 'value' => $_POST['entrega_medic_labo']],
    ['type' => 's', 'value' => $_POST['fecha_obstetrica']],
    ['type' => 's', 'value' => $_POST['edad_gesta']],
    ['type' => 's', 'value' => $_POST['resul_gest']],
    ['type' => 's', 'value' => $_POST['meto_fecundaE']],
    ['type' => 's', 'value' => $_POST['cual']],
    ['type' => 's', 'value' => $_POST['otro_cual']],
    ['type' => 's', 'value' => $_POST['motivo_nofecund']],
    ['type' => 's', 'value' => $_POST['control_mac']],
    ['type' => 's', 'value' => $_POST['fecha_control_mac']],
    ['type' => 's', 'value' => $_POST['ctrl_postpar_espe']],
    ['type' => 's', 'value' => $_POST['fecha_postpar_espe']],
    ['type' => 's', 'value' => $_POST['asis_ctrl_postpar_espe']],
    ['type' => 's', 'value' => $_POST['porque_no_postpar']],
    ['type' => 's', 'value' => $_POST['consul_apoy_lacmater']],
    ['type' => 's', 'value' => $_POST['signos_alarma']],
    ['type' => 's', 'value' => $_POST['desc_sigala']],
    ['type' => 's', 'value' => $_POST['disc_gesE']],
    ['type' => 's', 'value' => $_POST['cual_disc_ges']],
    ['type' => 's', 'value' => $_POST['fecha_apoy_lacmater']],
    ['type' => 's', 'value' => $_POST['peso_rcnv']],
    ['type' => 's', 'value' => $_POST['ctrl_recinac']],
    ['type' => 's', 'value' => $_POST['fecha_ctrl_nac']],
    ['type' => 's', 'value' => $_POST['asis_ctrl_reci']],
    ['type' => 's', 'value' => $_POST['porque_norec']],
    ['type' => 's', 'value' => $_POST['ult_peso']],
    ['type' => 's', 'value' => $_POST['consul_lacmate']],
    ['type' => 's', 'value' => $_POST['porque_nolact']],
    ['type' => 's', 'value' => $_POST['fecha_consul_lacmate']],
    ['type' => 's', 'value' => $_POST['asiste_ctrl_cyd']],
    ['type' => 's', 'value' => $_POST['vacuna_comple']],
    ['type' => 's', 'value' => $_POST['lacmate_exclu']],
    ['type' => 's', 'value' => $_POST['signos_alarma']],
    ['type' => 's', 'value' => $_POST['cam_sign']],
    ['type' => 's', 'value' => $_POST['qui_vida']],
    ['type' => 's', 'value' => $_POST['viv_malt']],
    ['type' => 's', 'value' => $_POST['adec_red']],
    ['type' => 's', 'value' => $_POST['fecha_egreopost']],
    ['type' => 's', 'value' => $_POST['estrategia_1']],
    ['type' => 's', 'value' => $_POST['estrategia_2']],
    ...
    ['type' => 's', 'value' => $_POST['ruta']],
    ['type' => 's', 'value' => $_POST['otras_condiciones']],
    ['type' => 's', 'value' => $_POST['observaciones']],
    ['type' => 's', 'value' => $_POST['cierre_caso']],
    ['type' => 's', 'value' => $_POST['motivo_cierre']],
    ['type' => 's', 'value' => $_POST['fecha_cierre']],
    ['type' => 's', 'value' => $_POST['conti_segespecial']],
