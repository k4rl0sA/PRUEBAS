...
function cmp_mme(){
  ...
  $c[]=new cmp('tiposeg','s','3',$ev,$w.' '.$o,'Tipo de Seguimiento','tiposeg',null,null,false,true,'','col-2',"mmeFechaHosp('IMc','1','1');");
  ...
  $c[]=new cmp('etapa','s','3',$d,$w.' hab '.$o,'Etapa','etapa',null,null,false,true,'','col-2',"enabEtap('etapa',['pRe','PuE','PYg']);weksEtap('etapa','PeT');mmeFechaHosp('HOs','3','1');");
  ...
  $o='gest';
    ...
    $c[]=new cmp('tipo_tratafarma','m','3',$d,$w.' pRe '.$o,'Tipo de Tratamiento','tipo_tratafarma',null,null,false,$x,'','col-2',"fieldsValue('tipo_tratafarma','');");
