...
function cmp_mme(){
  ...
  $o='gest';
    ...
    $c[]=new cmp('asis_ctrl_postpar_espe','s','3',$d,$w.' PuE aST '.$o,'¿Asistió a control post parto?','rta2',null,null,false,$x,'','col-2',"enabOthSi('ctrl_postpar_espe','NPp');validDate(this,-400,0);");
