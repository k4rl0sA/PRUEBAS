...
function cmp_mme(){
  ...
  $o='gest';
    ...
    $c[]=new cmp('fecha_egreopost','d','10',$d,$w.' PuE lME '.$o,'¿Finalización de caso 42 dìas post EGRESO HOSPITALARIO ?','fecha_egreopost',null,null,false,$x,'','col-3',"validaDate(this,-50,0);");
