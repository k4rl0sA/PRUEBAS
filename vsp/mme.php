...
function cmp_mme(){
  ...
  $c[]=new cmp('muertos','s','3',$d,$w.' PeT hab '.$o,'Muertos','fobs',null,null,false,false,'','col-2');  
    ...
    $c[]=new cmp('fecha_egre','d','10',$d,$w.' pRe '.$o,'Fecha de Egreso Hospitalario','fecha_egre',null,null,true,false,'','col-2',"validDate(this,$days,0);");//aplica solo para primer seguimiento
    ...
    $c[]=new cmp('asis_ctrl_postpar_espe','s','3',$d,$w.' PuE '.$o,'¿Asistió a control post parto?','rta',null,null,false,$x,'','col-2',"enabOthSi('ctrl_postpar_espe','Esp');");
    ...
    $c[]=new cmp('cual_disc_ges','t','500',$d,$w.' PuE MFe '.$o,'¿Cúal?','cual_disc_ges',null,null,false,$x,'','col-2');
    ...
    $c[]=new cmp('cam_sign','s','3',$d,$w.' PuE '.$o,'Considera que ha tenido cambios significativos recientes a nivel emocional, psicológico o comportamental (por ejemplo cambios de estado de ánimo o dificultades en el sueño)','rta',null,null,false,$x,'','col-2',"enabOthSi('cam_sign','lME');");
    $c[]=new cmp('qui_vida','s','3',$d,$w.' PuE '.$o,'Por su condición ha recientemente en quitarse la vida o lo ha intentado','rta',null,null,false,$x,'','col-2',"enabOthSi('qui_vida','lME');");
    $c[]=new cmp('viv_malt','s','3',$d,$w.' PuE '.$o,'Ha vivenciado de manera reciente algún tipo de violencia o maltrato en su familia','rta',null,null,false,$x,'','col-2',"enabOthSi('viv_malt','lME');");
    $c[]=new cmp('adec_red','s','3',$d,$w.' PuE '.$o,'Considera que cuenta con una adecuada red de apoyo social para cuidad, mantener y mejorar su estado de salud física y mental','rta',null,null,false,$x,'','col-2',"enabOthSi('adec_red','lME');");
    $c[]=new cmp('fecha_egreopost','d','10',$d,$w.' PuE lME '.$o,'¿Finalización de caso 42 dìas post EGRESO HOSPITALARIO ?','fecha_egreopost',null,null,false,true,'','col-2');
