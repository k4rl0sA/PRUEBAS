...
function cmp_mme(){
  ...
  $c[]=new cmp('muertos','s','3',$d,$w.' PeT hab '.$o,'Muertos','muertos',null,null,false,true,'','col-2');  
    ...
    $c[]=new cmp('fecha_egre','d','10',$d,$w.' '.$o,'Fecha de Egreso Hospitalario','fecha_egre',null,null,true,true,'','col-2',"validDate(this,30,0);");//aplica solo para primer seguimiento
    $c[]=new cmp('edad_padre','t',2,$d,$w.' pRe '.$o,'Edad del Padre','fpe','rgxpeso','##',false,$x,'','col-2');//aplica solo para primer seguimiento
