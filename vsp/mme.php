...
function cmp_mme(){
  ...
  $o='gest';
    ...
    $c[]=new cmp('asis_ctrl_recinac','s','3',$d,$w.' PuE AcR '.$o,'Asistió a control de recién nacido','rta',null,null,false,$x,'','col-2',"enabOthNo('asis_ctrl_recinac','CrT1');");
    $c[]=new cmp('porque_norec','t','500',$d,$w.' pRe CrT1 '.$o,'¿Por Qué?','porque_norec',null,null,false,false,'','col-3');
    $c[]=new cmp('ult_peso','sd','4',$d,$w.' PuE '.$o,'Último peso registrado','ult_peso','rgxpeso','##.#',false,false,'','col-2');
    $c[]=new cmp('consul_lacmate','s','3',$d,$w.' PuE '.$o,'¿Tiene consulta apoyo lactancia materna?','rta',null,null,false,$x,'','col-2',"enabOthSi('consul_lacmate','FlM');enabOthNo('consul_lacmate','nLM');");
    $c[]=new cmp('porque_nolact','t','500',$d,$w.' pRe nLM '.$o,'¿Por Qué?','porque_nolact',null,null,false,$x,'','col-3');
