...
function cmp_mme(){
  ...
  $c[]=new cmp('etapa','s','3',$d,$w.' hab '.$o,'Etapa','etapa',null,null,false,false,'','col-2',"enabEtap('etapa',['pRe','PuE','PYg']);weksEtap('etapa','PeT');valiEgreHosp();EnabDepe2fiel('HOs','1','2','numsegui','etapa',true,true);EnabDepe2fiel('IMc','3','1','tiposeg','etapa',false,true);");
