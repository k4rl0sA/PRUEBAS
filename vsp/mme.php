...
function cmp_mme(){
  ...
  $o='gest';
    ...
    $c[]=new cmp('porque_noadh','t','500',$d,$w.' pRe SiA '.$o,'¿Por Qué?','porque_noadh',null,null,false,$x,'','col-4',"enabOthNo('porque_noadh','nAd');");
    $c[]=new cmp('peso','sd',6,$d,$w.' pRe nAd '.$o,'Peso (Kg) Mín=0.50 - Máx=150.00','fpe','rgxpeso','##.#',false,$x,'','col-2');
