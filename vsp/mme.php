...
function cmp_mme(){
  ...
  $o='gest';
    ...
    $c[]=new cmp('fecha_egreopost','d','10',$d,$w.' '.$no.' '.$o,'Fecha de cierre por estrategia AG (42 días post evento obstetrico)','fecha_egreopost',null,null,false,$x,'','col-3',"validDate(this,0,50);");
