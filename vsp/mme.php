...
function cmp_mme(){
  ...
  $c[]=new cmp('tiposeg','s','3',$ev,$w.' '.$o,'Tipo de Seguimiento','tiposeg',null,null,false,true,'','col-2',"enabEtap('tiposeg',['aST']);enabEtap('tiposeg',['cRN']);");
  ...
  $o='gest';
    ...
    $c[]=new cmp('asis_ctrl_recinac','s','3',$d,$w.' PuE  '.$o,'Asistió a control de recién nacido','rta',null,null,false,$x,'','col-2',"enabOthSi('asis_ctrl_recinac','CrT1');");
    $c[]=new cmp('porque_norec','t','500',$d,$w.' pRe CrT '.$o,'¿Por Qué?','porque_norec',null,null,false,false,'','col-3');
    ...
    $c[]=new cmp('porque_nolact','t','500',$d,$w.' pRe '.$o,'¿Por Qué?','porque_nolact',null,null,false,$x,'','col-3');
