...
function focus_mme(){
 ...
 FUNCTION seg_mme(){
	// var_dump($_POST['id']);
	$id=divide($_POST['id']);
	$sql="SELECT `id_mme` ACCIONES,tipo_doc,documento,fecha_seg Fecha,numsegui Seguimiento,FN_CATALOGODESC(87,evento) EVENTO,FN_CATALOGODESC(73,estado_s) estado,cierre_caso Cierra,
...
FROM vsp_mme A
	...
	return panel_content($datos["responseResult"],"mme-lis",5);
   }
...
// var_dump($a);
// var_dump($rta);
	if ($a=='mme-lis' && $b=='acciones'){//a mnombre del modulo
		$rta="<nav class='menu right'>";	
		$rta.="<li class='icono editar' title='Editar' id='".$c['ACCIONES']."' Onclick=\"setTimeout(getData,500,'mme',event,this,['fecha_seg','numsegui','evento','estado_s','motivo_estado','etapa','sema_gest'],'mme.php');\"></li>";
	}
