...
function cmp_mme(){
  ...
  $o='gest';
    ...
    $c[]=new cmp('fecha_egreopost','d','10',$d,$w.' '.$no.' '.$o,'¿Finalización de caso 42 dìas post Evento Obstetrico ?','fecha_egreopost',null,null,false,$x,'','col-3',"validDate(this,0,50);");
