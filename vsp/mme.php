...
function cmp_mme(){
  ...
  $c[]=new cmp('etapa','s','3',$d,$w.' hab '.$o,'Etapa','etapa',null,null,false,true,'','col-2',"enabEtap('etapa',['pRe','PuE','PYg']);weksEtap('etapa','PeT');mmeFechaHosp('HOs','1','1');mmeFechaHosp('IMc','3','1');");
