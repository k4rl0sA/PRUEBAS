...
function cmp_mme(){
  ...
  $o='gest';
    ...
    $c[]=new cmp('adhe_tratafarma','s','3',$d,$w.' pRe '.$o,'Adhe de Tratafarma','rta',null,null,false,$x,'','col-2',"enabOthNo('adhe_tratafarma','nAd');");
    $c[]=new cmp('porque_noadh','t','500',$d,$w.' pRe nAd '.$o,'¿Por Qué?','porque_noadh',null,null,false,$x,'','col-4');
