...
$ob='Ob';
  ...
  $c[]=new cmp($o,'e',null,'INFORMACIÓN GESTANTE',$w);
    ...
    $c[]=new cmp('aplica_tamiz','s','2',$d,$w.' cc '.$ob.' '.$bl.' '.$o,'Se aplicó tamizaje POST test COPE?','rta',null,null,true,$x,'','col-15',"enabOthSi('aplica_tamiz','cLk');enabOthNo('aplica_tamiz','LKr');");
