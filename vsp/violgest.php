...
$ob='Ob';
  ...
  $c[]=new cmp('estado_s','s','3',$d,$w.' sTa '.$o,'Estado','estado_s',null,null,true,true,'','col-2',"enabFielSele(this,true,['motivo_estado'],['3']);EnabEfec(this,['hab','acc'],['Ob'],['nO'],['bL']);disaOthSi('estado_s','Vio');");
  ...
  $c[]=new cmp($o,'e',null,'INFORMACIÓN GESTANTE',$w);
    ...
    $c[]=new cmp('persis_riesgo','s','2',$d,$w.' '.$bl.' Vio '.$o,'¿Persisten los riesgos asociados a la violencia?','rta',null,null,false,$x,'','col-25');
    $c[]=new cmp('apoy_sector','s','2',$d,$w.' '.$bl.' Vio '.$o,'¿Cuenta con apoyo y/o seguimiento de otro sector?','rta',null,null,false,$x,'','col-25',"enabOthSi('apoy_sector','APy');");
    $c[]=new cmp('cual_sec','s','3',$d,$w.' '.$bl.' APy '.$o,'¿Cuál?','apoyo',null,null,false,$x,'','col-25');
