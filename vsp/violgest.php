...
$ob='Ob';
  ...
  $c[]=new cmp($o,'e',null,'INFORMACIÓN GESTANTE',$w);
    ...
    $c[]=new cmp('aplica_tamiz','s','2',$d,$w.' cc LKr '.$ob.' '.$o,'Se aplicó tamizaje POST test COPE?','rta',null,null,true,$x,'','col-15',"enabOthSi('aplica_tamiz','cLk');");
    ...
    $c[]=new cmp('cope_afronta','s','3',$d,$w.' cc cLk '.$bl.' '.$no.' '.$o,'Total Afrontamiento','afronta',null,null,false,$x,'','col-25');
    $c[]=new cmp('cope_evitacion','s','3',$d,$w.' cc cLk '.$bl.' '.$no.' '.$o,'Total Evitacion','afronta',null,null,false,$x,'','col-25');
    $c[]=new cmp('incremen_afron','s','3',$d,$w.' cc cLk '.$bl.' '.$no.' '.$o,'Tras la intervención se evidencia incremento en las estrategias de afrontamiento','incremen_afron',null,null,false,$x,'','col-25');
    $c[]=new cmp('incremen_evita','s','3',$d,$w.' cc cLk '.$bl.' '.$no.' '.$o,'Tras la intervención se evidencia decremento de las estrategias de evitación','incremen_afron',null,null,false,$x,'','col-25');
