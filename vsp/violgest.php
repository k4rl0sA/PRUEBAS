...
$ob='Ob';
  ...
  $c[]=new cmp($o,'e',null,'INFORMACIÓN GESTANTE',$w);
    ...
    $c[]=new cmp('persis_riesgo','s','2',$d,$w.' '.$bl.' '.$pu.' '.$ge.' '.$o,'¿Persisten los riesgos asociados a la violencia?','rta',null,null,false,$x,'','col-25');
    $c[]=new cmp('apoy_sector','s','2',$d,$w.' '.$bl.' '.$pu.' '.$ge.' '.$o,'¿Cuenta con apoyo y/o seguimiento de otro sector?','rta',null,null,false,$x,'','col-25',"enabOthSi('apoy_sector','APy');");
    $c[]=new cmp('cual_sec','s','3',$d,$w.' '.$bl.' '.$pu.' '.$ge.' APy '.$o,'¿Cuál?','apoyo',null,null,false,$x,'','col-25');
