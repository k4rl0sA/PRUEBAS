...
$ob='Ob';
  ...
  $c[]=new cmp($o,'e',null,'INFORMACIÓN GESTANTE',$w);
    ...
    $c[]=new cmp('cual_sec','s','3',$d,$w.' Vio APy '.$o,'¿Cuál?','apoyo',null,null,false,$x,'','col-25');
    $c[]=new cmp('tam_cope','s','2',$d,$w.' acc '.$bl.' '.$o,'Aplicación tamizaje PRE COPE','rta',null,null,false,$x,'','col-25',"enabOthSi('tam_cope','pCo');");
