...
$ob='Ob';
  ...
  $c[]=new cmp('estado_s','s','3',$d,$w.' sTa '.$o,'Estado','estado_s',null,null,true,true,'','col-2',"enabFielSele(this,true,['motivo_estado'],['3']);enabOthNo('estado_s','PCo');EnabEfec(this,['hab','acc'],['Ob'],['nO'],['bL']);");
