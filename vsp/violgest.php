...
$ob='Ob';
  ...
  $c[]=new cmp($o,'e',null,'INFORMACIÓN GESTANTE',$w);
    ...
    $c[]=new cmp('aplica_tamiz','s','2',$d,$w.'  '.$ob.' '.$o,'Se aplicó tamizaje POST test COPE?','rta',null,null,true,true,'','col-15',"enabOthSi('aplica_tamiz','cLk');disaOthNo('aplica_tamiz','LKr');");
...
function gra_violgest(){
  ...
  `usu_update`=TRIM(UPPER('{$_SESSION['us_sds']}')),`fecha_update`=DATE_SUB(NOW(), INTERVAL 5 HOUR) 
    ...
    $eq=opc_equ();
    $sql="INSERT INTO vsp_violges VALUES (NULL,trim(upper('{$id[0]}')),
