...
$ob='Ob';
  ...
  $c[]=new cmp($o,'e',null,'INFORMACIÓN GESTANTE',$w);
    ...
    $c[]=new cmp('aplica_tamiz','s','2',$d,$w.'  '.$ob.' '.$o,'Se aplicó tamizaje POST test COPE?','rta',null,null,true,$x,'','col-15',"enabOthSi('aplica_tamiz','cLk');disaOthNo('aplica_tamiz','LKr');");
