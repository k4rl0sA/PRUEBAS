...
function cmp_tamWhodas(){
  ...
  $c[]=new cmp('whodas_analisis','t',20,'',$w.' '.$o,'Clasificación','porcentaje_total',null,'',false,false,'','col-4');
  $c[]=new cmp('whodas_momento','t',20,'',$w.' '.$o,'Momento','whodas_momento',null,'',false,false,'','col-3');
